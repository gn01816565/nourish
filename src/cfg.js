...
(function () {
  ...
  const CFG = {
      ...
      pool: [
        {
          ...
          label:"櫻花飄落",
          labelKey:"seasonal.label.sakura",
          apply:"sakura",
        ...
        },
        {
          ...
          weight:30,
          label:"情人節愛心",
          labelKey:"seasonal.label.valentine",
          apply:"valentine",
        ...
        },
        {
          ...
          weight:25,
          label:"夏日涼風",
          labelKey:"seasonal.label.summer_breeze",
          apply:"summer_breeze",
        ...
        },
        {
          ...
          weight:25,
          label:"月餅",
          labelKey:"seasonal.label.mooncake",
          apply:"mooncake",
        ...
        },
        {
          ...
          weight:25,
          label:"萬聖節糖果",
          labelKey:"seasonal.label.halloween",
          apply:"halloween",
        ...
        // 野餐 motif 是 cottagecore-boho 主流 pinterest aesthetic（gingham 紅白格紋 + 編織籃 + 戶外用餐）
        {
          ...
          weight:25,
          label:"夏日野餐墊",
          labelKey:"seasonal.label.picnic_blanket",
        ...
        // 文具組（筆記本 / 鉛筆 / 墨水 / 蘋果）對齊智慧軸 sage / book / message_bottle 學術氛圍
        {
          ...
          weight:25,
          label:"教師節文具",
          labelKey:"seasonal.label.stationery_set",
        ...
        {
          id:"dance_tutu",
          art:"assets/images/event-dance-tutu.png",
          weight:25,
          label:"舞蹈節 tutu",
          labelKey:"seasonal.label.dance_tutu",
          apply:"dance_tutu",
        ...
        {
          id:"winter_starlight",
          art:"assets/images/event-winter-starlight.png",
          weight:25,
          label:"冬至星空",
          labelKey:"seasonal.label.winter_starlight",
        ...
        {
          id:"spa_salts",
          art:"assets/images/event-spa-salts.png",
          weight:25,
          label:"SPA 浴鹽",
          labelKey:"seasonal.label.spa_salts",
          apply:"spa_salts",
        ...
        // iter#215 y2k 軸首 seasonal — World Wide Web Day 08-01 anchor，7 天 window（在 summer_breeze 整月期間 narrow 慶祝層）
        // 復古手持遊戲機（粉色 frame + cyan 螢幕 + chromatic glitch + d-pad + A/B buttons）— 對齊 pixel_heart / star_clip / cd_pendant y2k 數位 nostalgia
        {
          id:"retro_console",
          art:"assets/svg/event-retro-console.svg",
          weight:25,
          label:"復古遊戲機",
          labelKey:"seasonal.label.retro_console",
          apply:"retro_console",
        ...
        // iter#227 dark academia 軸首 seasonal — Halloween 10-31 anchor，7 天 window（10-03 ~ 12-18 是日曆大缺口，stationery_set 結束後到 winter_starlight 之間無事件）
        ...
        // iter#228 minimalist 軸首 seasonal — New Year 01-01 anchor，7 天 window（01-01 ~ 02-11 是 January 全月日曆大缺口，valentine 02-12 起前無事件）
        // 純白雪景 + 單一細樹 + 單一晨陽 + 單一小鳥 + callback morning_coffee 杯 — 對齊 minimal_chain / morning_coffee / minimal_pin minimalism「fresh start intentional dawn」narrative
        ...
        // iter#233 kawaii-decora 軸首 seasonal — White Day 03-14 anchor，7 天 window（02-16 ~ 03-19 是 valentine 結束後到 sakura 起前的縫隙，跟 valentine 接力 chocolate-return narrative）
        // 多色禮盒堆疊 + 多顆 heart confetti + 多色 ✦ — 對齊 decora_clips / candy_jar / plush_bow 軸 narrative「堆量」+ pastel rainbow palette
        // 跟 valentine 02-12 區隔：valentine = 收到玫瑰花束 / 本件 = 收到多色 White Day 回禮
        {
          id:"white_day_gifts",
          art:"assets/svg/event-white-day-gifts.svg",
          weight:25,
          label:"白色情人節禮盒",
          labelKey:"seasonal.label.white_day_gifts",
          apply:"white_day_gifts",
          applyEffects:{ stats:{mood:22, hunger:6, clean:3}, coin:18, coinReason:"白色情人節" },
          applyToastKey:"seasonal.white_day_gifts",
          applyToast:"🎁 收到一堆 White Day 禮盒~ 拆開五彩繽紛",
          applyToastStyle:"gold",
          dateRange: { from: "03-11", to: "03-17" },
        },
      ],
    },
    randomEvents: {
      ...
      pool: [
        ...
        { id:"coin_drop", art:"assets/images/event-coin.png",      weight:55, label:"撿到飼料幣", labelKey:"event.label.coin_drop", apply:"coin_drop" },
        { id:"herb",      art:"assets/images/event-herb.png",      weight:18, label:"神祕草藥",   labelKey:"event.label.herb", apply:"herb",      applyEffects:{ stats:{hunger:30, mood:5, clean:5, energy:30} }, applyToastKey:"event.herb",      applyToast:"🌿 神祕草藥！全身舒暢" },
        { id:"butterfly", art:"assets/images/event-butterfly.png", weight:14, label:"蝴蝶飛過",   labelKey:"event.label.butterfly", apply:"butterfly", applyEffects:{ stats:{mood:10} },                                applyToastKey:"event.butterfly", applyToast:"🦋 蝴蝶讓啾啾很開心" },
        { id:"fly",       art:"assets/images/event-fly.png",       weight:10, label:"趕走果蠅",   labelKey:"event.label.fly", apply:"fly",       applyEffects:{ stats:{clean:5, mood:3} },                       applyToastKey:"event.fly",       applyToast:"趕走果蠅！清潔 +5" },
        ...
        { id:"towel",     art:"assets/svg/event-towel.svg",          weight:7,  label:"軟綿綿毛巾",  labelKey:"event.label.towel", apply:"towel",      applyEffects:{ stats:{clean:14, mood:6} },                                                        applyToastKey:"event.towel",       applyToast:"🛁 暖暖的乾毛巾~ 全身舒服" },
        // iter#200 智慧軸第二 event：漂流瓶 — 跟既有 book 區隔（book = 讀書當下 / message-bottle = 遠方智慧 / 神祕緣分）；微 coin 5 暗示「字條中夾著」
        { id:"message_bottle", art:"assets/svg/event-message-bottle.svg", weight:5, label:"漂流瓶", labelKey:"event.label.message_bottle", apply:"message_bottle", applyEffects:{ stats:{mood:12, energy:6}, coin:5, coinReason:"瓶中字條" },                       applyToastKey:"event.message_bottle", applyToast:"📜 漂流瓶裡有給你的字條~" },
        // iter#201 balletcore 軸第二 event：足尖鞋 — 跟既有 rose_bouquet 區隔（rose_bouquet = 演出後收花 / pointe_shoe = 後台練功時刻）；無 coin 純 atmospheric
        { id:"pointe_shoe", art:"assets/svg/event-pointe-shoe.svg",       weight:6, label:"練舞時光", labelKey:"event.label.pointe_shoe", apply:"pointe_shoe", applyEffects:{ stats:{mood:10, energy:8} },                                                       applyToastKey:"event.pointe_shoe",    applyToast:"🩰 排練好的腳尖鞋~ 充滿力量" },
        // iter#202 fairycore 軸第二 event：月光 — 跟既有 dewdrop 區隔（dewdrop = 葉上自然清晨 / moonlight = 夜晚仙氣神祕）；palette 軟化處理（粉色暖光暈 + 奶油白月）對齊 TA「避免過冷」約束
        { id:"moonlight", art:"assets/svg/event-moonlight.svg",          weight:6, label:"月光灑落", labelKey:"event.label.moonlight", apply:"moonlight",   applyEffects:{ stats:{mood:14, clean:5, energy:5} },                                              applyToastKey:"event.moonlight",       applyToast:"🌙 月光灑下~ 啾啾被柔光擁抱" },
        // iter#203 元氣軸第二 event：彩帶煙火 — 跟既有 rainbow 區隔（rainbow = 廣域 atmospheric / confetti_pop = 慶祝動感 burst）；coin 7 暗示「派對小費」
        { id:"confetti_pop", art:"assets/svg/event-confetti-pop.svg",    weight:5, label:"彩帶煙火", labelKey:"event.label.confetti_pop", apply:"confetti_pop", applyEffects:{ stats:{mood:18, energy:6}, coin:7, coinReason:"派對驚喜" },                       applyToastKey:"event.confetti_pop",   applyToast:"🎉 砰！彩帶煙火爆出~" },
    ...
    accessories: {
      ...
      minimal_chain:   { slot:"neck", art:"assets/svg/acc-minimal-chain.svg",  labelKey:"acc.minimal_chain",  label:"簡約細鏈",     icon:"🪙", price:160 },
      // iter#225 minimalist 軸第三件 — 簡約一字夾（single thin gold bobby pin）；達 GDD §5.5「軸 ≥ 3 件」成形門檻；hat slot 跟 minimal_chain neck slot 區隔可同時佩戴；跟 strawberry_clip/star_clip 已有 hat clip 視覺區隔（後者 figurative motif vs 本件 single bar 純線條）
      minimal_pin:     { slot:"hat",  art:"assets/svg/acc-minimal-pin.svg",    labelKey:"acc.minimal_pin",    label:"簡約一字夾",   icon:"📌", price:140 },
      // iter#229 v0.6 第 12 美學軸 kawaii-decora 起手第一件 — 多髮夾堆疊組（5 顆並列 star/cherry/heart/bow/candy 不同 motif 髮夾 + 多色 pastel rainbow + 多顆 tiny dots + 多顆 ✦）；narrative「堆量 / 過度可愛」直接對立 minimalism「不堆」軸 — 跨軸混搭強化「choose your aesthetic axis」承諾的 spectrum 兩端
      decora_clips:    { slot:"hat",  art:"assets/svg/acc-decora-clips.svg",   labelKey:"acc.decora_clips",   label:"多色髮夾組",   icon:"🎀", price:200 },
      // iter#231 kawaii-decora 軸第三件 — 蓬蓬蝴蝶結（triple-layer pastel rainbow bow + pearl center + 多 ribbon tails + 3 ✦ + 4 corner dots）；達 GDD §5.5「軸 ≥ 3 件」成形門檻；neck slot 跟 decora_clips hat slot 互補可同時佩戴；跟 bow / velvet_bow / ribbon_tie 既有 bow 區隔（單色精緻 vs 本件 triple-layer 多色堆疊）
      plush_bow:       { slot:"neck", art:"assets/svg/acc-plush-bow.svg",      labelKey:"acc.plush_bow",      label:"蓬蓬蝴蝶結",   icon:"🎀", price:230 },
    },
    ...
    petArt: {
      ...
      adult: {
        ...
        // PLACEHOLDER: drifter 終態暫用 healthy art，待 docs/image-prompts.md §8.8 生圖補上 chick-adult-drifter.png
